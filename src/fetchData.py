...
catalog = client.get_events(starttime=t0, endtime=te, minmagnitude=7, maxmagnitude=8, latitude=stla, longitude=stlo,
...
for i in range(0, nevents):
    # get origin time for data retrieval
    ...
    evla = catalog.events[i].origins[0].latitude
    evlo = catalog.events[i].origins[0].longitude
    evdp = catalog.events[i].origins[0].depth/1000
